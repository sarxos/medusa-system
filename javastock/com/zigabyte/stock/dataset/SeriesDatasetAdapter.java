...
/** Base abstract class that forwards {@link SeriesDataset} methods to another
    dataset, for creating an adapter that overrides a subset of the methods. **/
public class SeriesDatasetAdapter extends DatasetAdapter
implements SeriesDataset {
  private final SeriesDataset dataset;
  public SeriesDatasetAdapter(SeriesDataset dataset) {
    super(dataset);
