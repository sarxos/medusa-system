 ...
 */
public class EE extends AbstractGenerator<Quote> {
	...
	public Signal generate(Quote q) {
		...
		if (isOutputting()) {
			signal.addValue(new Value("EMA1", e1));
			signal.addValue(new Value("EMA2", s1));
		}
	...
	public static void main(String[] args) {
		...
		while (ei.hasNext()) {
			...
			Method[] methods = EE.class.getDeclaredMethods();
